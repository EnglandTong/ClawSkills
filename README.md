...
| --- | --- | --- |
| `agent-loop-engineering` | 1.0.0 | Top-level loop controller for long-running AI coding work with persistent `Docs/` state, AI Coding Production System guidance, automation runner guidance, stop gates, completion gates, runner adapters, and context budgeting. |
